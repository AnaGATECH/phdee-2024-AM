...
\noindent 1. The average treatment effect from the second-stage regression results is presented in Tabel \ref{tab:stataRD} and the scatter plot with fitted lines in Figure \ref{fig:StataScatter}. 

\begin{table}[h]
    \centering
    \input{homework 7/output/figure/hw7_stata}
    \caption{RD regression output}
    \label{tab:stataRD}
\end{table}
